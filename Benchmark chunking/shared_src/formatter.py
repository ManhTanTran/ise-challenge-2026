...
def strip_markdown(text: str) -> str:
    """Flatten markdown image/link syntax to plain prose for submission.

    LLM answers sometimes wrap a file reference in markdown, e.g.
    "![Ảnh iSE](members.png)". A submission wants plain text, so keep the label
    and target but drop the markdown punctuation, and remove stray emphasis
    markers. Plain answers (no markdown) are returned unchanged.
    """
